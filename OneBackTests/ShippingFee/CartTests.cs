...
namespace OneBackTests.ShippingFee;
...
public class CartTests
{
    ...
    {
        double shippingFee = cart.ShippingFee(blackCat, new Product(new Size(30, 20, 10), 5));
    ...
    {
        double shippingFee = cart.ShippingFee(blackCat, new Product(new Size(30, 20, 10), 50));
    ...
    {
        double shippingFee = cart.ShippingFee(hsinchu, new Product(new Size(30, 20, 10), 50));
    ...
    {
        double shippingFee = cart.ShippingFee(hsinchu, new Product(new Size(100, 20, 10), 50));
    ...
    {
        double shippingFee = cart.ShippingFee(postOffice, new Product(new Size(100, 20, 10), 3));
    ...
    {
        double shippingFee = cart.ShippingFee(postOffice, new Product(new Size(100, 20, 10), 300));
